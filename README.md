...
cette plateforme offre une expérience complète aux passionnés de jeux vidéo.')">Steam, c'est quoi ?</a>
    <a href="#" class="bouton espace" onclick="afficherTexte('Alors, pour installer Steam, il faut déjà aller sur un site de confiance, en l\'occurrence, le site officiel.<br>Voici le lien vers la page de téléchargement officiel de Steam : <a href=\'https://store.steampowered.com/about/\'>https://store.steampowered.com/about/</a>, et voici le lien vers le pdf que j\'ai écris pour aider la manipulation de Steam et d'autres :<a href="E:/programmation/lien de téléchargement de steam.pdf" download="lien de téléchargement de steam.pdf">Télécharger le PDF</a>')">Comment installer Steam</a>
